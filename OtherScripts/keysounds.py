...
class TypeWriterSounds:
    ...
    def __init__(self):
        ...
        self.keysounds = {
            'load' : pygame.mixer.Sound('keysounds/manual_load_long.wav'),
            'shift' : pygame.mixer.Sound('keysounds/manual_shift.wav'),
            'delete': pygame.mixer.Sound('keysounds/manual_backspace.wav'),
            'space': pygame.mixer.Sound('keysounds/manual_space.wav'),
            'key': pygame.mixer.Sound('keysounds/manual_key.wav'),
            'enter': pygame.mixer.Sound('keysounds/manual_return.wav'),
            'bell': pygame.mixer.Sound('keysounds/manual_bell.wav')
        }
